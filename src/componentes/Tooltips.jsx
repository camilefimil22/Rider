    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a data-social="whatsapp" aria-label="Whatsapp" href="https://api.whatsapp.com/send?phone=542945546956&text=Hola%2C%20quiero%20hacer%20un%20pedido.">
        ...
        <li className="icon-content">
          <a data-social="facebook" aria-label="Facebook" href="https://www.facebook.com/rider.brewingbar/">
            <div className="filled" />
        ...
        <li className="icon-content">
          <a data-social="instagram" aria-label="Instagram" href="https://www.instagram.com/rider_bar/?hl=es">
            <div className="filled" />
