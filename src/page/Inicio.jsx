...
const demoItems = [
  ...
  { link: 'Menuincluisvo', text: 'Menú Inclusivo', image: 'https://tse1.mm.bing.net/th/id/OIP.td3aUV0e8Wy7lQqnFtB5gwHaHa?rs=1&pid=ImgDetMain' },
...
<div className=' h-full'> 
 ...
 <div  style={{ height: '600px', position: 'relative' }}>
  ...
  <div className='flex justify-center'>
    <div className='mt-50 flex flex-col w-20'>
      <Tooltip />
    </div>
  </div>
