...
export default function Ubicacion(){
    ...
    return(
     ...
     <div className="grid row-span-3 w-320  bg-[url(https://i.pinimg.com/736x/a0/b2/55/a0b255d287fdd333340755892a1ba626.jpg)] ">
        ...
        <ImLocation className="text-4xl"/>
         ...
         <div className=" mt-15 ml-20 hover:text-white transition-transform duration-300 hover:scale-110 ">
      ...
      <div className="flex mt-15 ml-20 hover:text-white transition-transform duration-300 hover:scale-110">
